...
public class FormXMLSplicer extends DefaultHandler
{
	...
	public void startElement(String s, String s1, String elementName, Attributes attributes) throws SAXException
	{
		...
		if(elementName.equalsIgnoreCase("div")) whatobj = new Div();
		if(elementName.equalsIgnoreCase("textbox")) { whatobj = new Textbox(); whatobj.setDroppable("true"); }
		if(elementName.equalsIgnoreCase("decimalbox")) whatobj = new Decimalbox();
		...
		if(whatobj != null)
		{
			...
			if(gotattrib)
			{
				...
				theval = attributes.getValue("format");
				if(theval != null) whatobj.setFormat(theval);
